    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-peach-50 to-orange-50">
        <div className="text-center">
          ...
          <p className="text-peach-700 text-lg">Memuat dashboard Anda...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-peach-50 via-white to-orange-50">
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        {/* Welcome Card */}
        <div className="mb-8">
          <Card className="bg-[#FDEFF7] border border-[#FADCEB] shadow-lg">
            <CardContent className="p-6">
              <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-4 space-y-4 lg:space-y-0">
                <div className="p-3 bg-white rounded-full shadow-sm self-start">
                  <Heart className="h-8 w-8 text-[#944D8A]" />
                </div>
                <div className="flex-1 text-center lg:text-left">
                  <h2 className="text-xl font-semibold text-gray-800">Prioritaskan Kesehatan Mental Anda</h2>
                  <p className="text-gray-600 mt-1">Konsultasi dengan psikolog dan psikiater berpengalaman untuk kesejahteraan mental yang lebih baik.</p>
                </div>
                <div className="flex flex-col sm:flex-row sm:flex-wrap lg:flex-nowrap gap-2">
                  <Button
                    onClick={() => setShowMoodDialog(true)}
                    className="py-2 px-3 text-sm bg-[#944D8A] hover:bg-[#7a3d72] text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                ...
                <div className="space-y-4">
                  {consultations.length === 0 ? (
                    ...
                    consultations.map((consultation) => (
                      <div key={consultation.id} className="border border-peach-100 rounded-xl p-6 bg-gradient-to-r from-white to-peach-50/30 hover:shadow-md transition-all duration-200">
                        <div className="flex justify-between items-start mb-4">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-1 text-sm text-gray-500">
                              ...
                              <span>{consultation.createdAt?.toDate?.()?.toLocaleDateString('id-ID', {
                                weekday: 'long',
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric'
          ...
          <div className="space-y-6">
            <Card className="shadow-lg border-0 bg-white/90 backdrop-blur-sm">
              <CardHeader className="bg-gradient-to-r from-peach-50 to-orange-50 rounded-t-lg">
                ...
                <CardDescription className="text-gray-600">Psikolog dan psikiater tersedia</CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="space-y-4">
                  {doctors.length === 0 ? (
                    ...
                    doctors.map((doctor) => (
                      <div key={doctor.id} className="p-4 border border-peach-100 rounded-lg bg-gradient-to-r from-white to-peach-50/20 hover:shadow-sm transition-all duration-200">
                        <div className="flex items-center space-x-3">
